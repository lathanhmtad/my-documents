...
`closing_balance`, `create_dt`)  VALUES (UUID(), 1865764534, 1, CURDATE(), 'Coffee Shop', 'Withdrawal', 30,34500,CURDATE()-2);

INSERT INTO `account_transactions` (`transaction_id`, `account_number`, `customer_id`, `transaction_dt`, `transaction_summary`, `transaction_type`,`transaction_amt`,
`closing_balance`, `create_dt`)  VALUES (UUID(), 1865764534, 1, CURDATE()-3, 'Uber', 'Withdrawal', 100,34400,CURDATE()-3);
